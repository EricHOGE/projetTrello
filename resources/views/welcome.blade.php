                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        <a class="navbar-brand" href="/">
                            <div class="logo-image" >
                                <img src="/images/ToDoTeam.png" class="img-fluid" style="height:61px; margin-left:70%;">
                            </div>
                    </a>    
                    @auth
            ...
            @endif
                ...
                <div class="logo" style="text-align: center; margin-bottom: 15%;">
                    ...
                    <div class="listcolumn" style="display:flex;justify-content: space-evenly;padding-right: 20%;padding-left: 20%;gap: 9%;text-align: center; background-color:rgba(255, 166, 0, 0.075);">
                        ...
                        <div class="colummn1">
                            <h1>Le tableau n'est que le commencement</h1>
                            <p>Les listes et les cartes constituent les bases de l'organisation du travail sur un tableau Trello. Ajoutez-y ensuite des attributions de tâches, des chronogrammes, des métriques de productivité, des calendriers et plus encore.</p>
                        </div>
                        <div class="colummn3">
                            <h1>Les cartes contiennent tous les éléments dont vous avez besoin</h1>
